...
.logout{
    ...
    <body>
    <div class="header">
  <a href="#default" class="logo"><img src="./images/schoollogo.png" width="80" height="70" ></a>
    <p class="schooname">Burayoc Elementary School</p>
    <div class="logout"><a href="index.php"><Button ><img class="icons" src="images/icon/logout.png" width="30px" height="30px"/> LOGOUT</Button></a></div>
